 ...
 * Source: TwinCAT.Ads.dll By Beckhoff
 */
export declare const ADS_UPLOAD_INFO_FLAGS: {
    None: number;
    Is64BitPlatform: number;
    IncludesBaseTypes: number;
    Utf8EncodedStringData: number;
    /** Return given flag value as string array */
    toStringArray: (flags: number) => string[];
};
/**
 ...
 * Source: TwinCAT.Ads.dll By Beckhoff
 */
export declare const ADS_SYSTEM_SERVICE_STATE_FLAGS: {
...
export declare const BASE_DATA_TYPES: {
     ...
     */
    toBuffer: (name: string, value: PlcPrimitiveType | Date, buffer?: Buffer) => Buffer<ArrayBufferLike>;
    /**
     ...
     */
    fromBuffer: (name: string, buffer: Buffer, convertDates: boolean) => string | number | bigint | boolean | Buffer<ArrayBufferLike> | Date;
    /**
 ...
 * @returns
 */
export declare const decodePlcStringBuffer: (data: Buffer, UTF8?: boolean) => string;
/**
 ...
 * @returns
 */
export declare const encodeStringToPlcStringBuffer: (str: string, UTF8?: boolean) => Buffer<ArrayBufferLike>;
/**
 ...
 * @returns
 */
export declare const encodeStringToPlcWstringBuffer: (str: string) => Buffer<ArrayBufferLike>;
/**
